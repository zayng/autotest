...
class PythonOrgSearch(unittest.TestCase):
    ...
    def test_search_in_python_org(self):
        ...
        Note that is does not look for any particular test search results page.This test verifies that the
        results were not empty
        """

        #Load the main page. In this case the home page of page.org.
