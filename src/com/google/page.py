...
class BasePage(object):
    """Base class to initalize the base page that will be called  from all pages"""

    def __init__(self, driver):
        self.driver = driver

class MainPage(BasePage):
    """Home page action menthods come here. I.e. Python.org"""
...
class SearchResultsPage(BasePage):
    ...
    def is_results_found(self):
        #Probably shoud search for this text in the specific page
